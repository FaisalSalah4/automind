...
import { AccidentForm } from '@/components/accidents/accident-form'
...
export default async function NewAccidentPage({
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <div>
        <h1 className="text-3xl font-bold">Log Accident</h1>
        <p className="text-muted-foreground">Record an accident or incident</p>
      </div>
      <AccidentForm cars={cars} defaultCarId={selectedCarId} currencySymbol={currencySymbol} />
    </div>
  )
}
